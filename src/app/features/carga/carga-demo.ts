...
/**
 * Carga de documentos · MODO DEMO (Mayo 2026). Flujo simulado con datos de
 * ejemplo y previsualización de solo lectura, sin persistencia. El periodo real
 * (Junio 2026 en adelante) lo maneja el componente `Carga`, que delega aquí
 * cuando el periodo seleccionado es el de demostración.
 */
@Component({
  selector: 'app-carga-demo',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [RouterLink, ProcessStepperComponent, IconComponent, UsdPipe],
  templateUrl: './carga-demo.html',
  styleUrl: './carga.css',
})
export class CargaDemo implements OnDestroy {
